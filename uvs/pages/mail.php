...
include('connexion.php');
                ...
                $headers = 'From: UVS0test@gmail.com' . "\r\n" .
                 ...
                 'X-Mailer: PHP/' . phpversion();
                  if(mail($destinataire, $sujet, $message,$headers)){
                       ...
                       /* $req=$bdd->prepare('insert into CampagneMail(destinataire,message,date,heure) values(:destinataire,:message,:date,:heure)');
                        $req->execute(array(':destinataire'=>$_POST['destinataire'],':message'=>$_POST['message'],':date'=>$date,':heure'=>$heure)); 
                        $req->closeCursor();*/
                      ?>
                       <script type = "text/javascript">
                            res = alert('Mail bien envoyé');
                       </script><?php
                        }
                    else{
                    ?>
                        <script type = "text/javascript">
                            res = alert("Echec de l'envoi");
                       </script><?php
                    } 
                }
         ?>
    ...
    elseif(isset($_POST['envoyer']) ){        
        $destinataire = $_POST['destinataire'];// Adresse email du destinataire
        $sujet = $_POST['nomCampagne']; // Titre de l'email
        $message = $_POST['message'];
        $message = wordwrap($message, 70, "\r\n");
        $headers = 'From: UVS0test@gmail.com' . "\r\n" .
         'Reply-To: UVS0test@gmail.com' . "\r\n" .
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Campagne Mail</h1>
                                ...
                                <div class="panel panel-yellow">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group input-group">
                                                ...
                                                <input type="email" name="destinataire"  id='destinataire' class="form-control" placeholder="exemple@exemple.com">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input type="text" name="nomCampagne" id="nomCampagne"  class="form-control" required>
                                        </div>
                                        <div class="form-group input-group">
