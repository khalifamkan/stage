<?php
    ...
    include "api.php";
    $rest = new RestClient();
    if(isset($_POST['envoyer']) && isset($_POST['nomGroupe']) && isset($_POST['description'])){

            $data = array();
            $data["name"]  = $_POST['nomGroupe'];
            $data["description"]  =  $_POST['description'];
            $unUser = json_encode( $data );
            $rest->setUrl('http://admin:passer@localhost:9090/plugins/restapi/v1/groups/'.$_POST['oldnameGroup'])->put($unUser);
            $opts = array(
                'http'=>array(
                    'method'=>"GET",
            ...
            $file = file_get_contents('http://admin:passer@localhost:9090/plugins/restapi/v1/groups', false, $context);
            $vod = fopen("vod.xml", "w+");
            fwrite($vod,$file);
            ?>
                   <script type = "text/javascript">
                        res = alert('Le groupe a étè modifié');
                   </script><?php
        }
?>
<!DOCTYPE html>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Groupe de Conférence</h1>
                                    ...
                                    <div class="panel-body">
                                        <form action="<?php  echo($_SERVER['PHP_SELF']); ?>" method="POST" id="chgfiliere">
                                         ...
                                         <div class="form-group input-group">
                                            <span class="input-group-addon" >Old name Group &nbsp;</span>
                                            <select name="oldnameGroup" class="form-control">
                                                <?php
                                              $dom = new DomDocument;
                                              $dom->load("vod.xml");
                                        ...
                                        <div class="form-group input-group">
                                            <span class="input-group-addon">New name Group </span>
                                            <input type="text" name="nomGroupe" id="nomGroupe"  class="form-control" required>
                                        </div>
                                        <div class="form-group input-group">
