<?php
    ...
    include "api.php";
    $rest = new RestClient();
    if(isset($_POST['envoyer']) && isset($_POST['groupe'])){
        $rest->setUrl('http://admin:passer@localhost:9090/plugins/restapi/v1/groups/'.$_POST['groupe'])->delete();
        $opts = array(
            'http'=>array(
                'method'=>"GET",
        ...
        ?>
               <script type = "text/javascript">
                    res = alert('Groupe bien Supprimé');
               </script><?php
    }
                                ...
                                <li>
                                    <a href="#"><i class="fa fa-group"></i> Groupe<span class="fa arrow"></a>
                                        <ul class="nav nav-third-level">
                                            ...
                                            <li>
                                                <a href="ModofierGroupe.php">Modifier</a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <?php
                                              ...
                                              foreach($listePays as $pays)
                                                ///echo $pays->firstChild->nodeValue;
