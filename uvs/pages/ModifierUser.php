<?php
    ...
    include "api.php";
    $rest = new RestClient();
    if(isset($_POST['envoyer']) && isset($_POST['username']) && isset($_POST['password'])){

        if ($_POST['oldusername']=='admin' || $_POST['oldusername'] == 'focus' || $_POST['oldusername']=='demo') {
            echo $_POST['username'];
            ?><script type = "text/javascript">
                    res = alert('Impossible de Modifier cet utilisateur');
            </script><?php
        }else{
            ...
            $unUser = json_encode( $data );
            $rest->setUrl('http://admin:passer@localhost:9090/plugins/restapi/v1/users/'.$_POST['oldusername'])->put($unUser);
            $opts = array(
                'http'=>array(
                    'method'=>"GET",
            ...
            ?>
                   <script type = "text/javascript">
                        res = alert('L\'utilisateur a étè modifié');
                   </script><?php
        }
    }
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="#"><i class="fa fa-wrench fa-fw"></i>  Créer Conférence</a>
                                        <ul class="nav nav-third-level">
                                            <li>
                                ...
                                <div class="panel panel-yellow">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group input-group">
                                            <span class="input-group-addon" >Old dUsername &nbsp;</span>
                                            <select name="oldusername" class="form-control">
                                                <?php
                                              $dom = new DomDocument;
                                              $dom->load("users.xml");
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input type="email" name="email" id="email" class="form-control" placeholder="example@exemple.com">
                                        </div>
                                        ...
                                        <div align="center">
                                        <button type="submit" name="envoyer" value="envoyer" class="btn btn-outline btn-primary">Modifier</button>
