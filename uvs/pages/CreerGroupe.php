<?php
    ...
    if(isset($_POST['envoyer']) && isset($_POST['nomGroupe']) && isset($_POST['description'])){
        ...
        $unGroupe = json_encode( $data );
        $rest->setUrl('http://admin:passer@localhost:9090/plugins/restapi/v1/groups')->post($unGroupe);
        $opts = array(
            'http'=>array(
                'method'=>"GET",
                                ...
                                <div class="panel panel-yellow">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input type="text" name="nomGroupe" id="nomGroupe"  class="form-control" placeholder="utiliser les caractère [aA-zZ],[0-9],'_' et '-'"required>
                                        </div>
                                        <div class="form-group input-group">
