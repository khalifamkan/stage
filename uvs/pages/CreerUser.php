<?php
    ...
    if(isset($_POST['envoyer']) && isset($_POST['username']) && isset($_POST['password'])){
        ...
        $rest->setUrl('http://admin:passer@localhost:9090/plugins/restapi/v1/users')->post($unUser);
        $rest->setUrl('http://admin:passer@localhost:9090/plugins/restapi/v1/users/'.$_POST['username'].'/groups/'.$_POST['groupe'])->post();
        $opts = array(
            'http'=>array(
                'method'=>"GET",
        ...
        $users = fopen("users.xml", "w+");
        fwrite($users,$file);
        ?>
               <script type = "text/javascript">
                    res = alert('l\'tilisateur a étè bien crée');
               </script><?php
    }
                                ...
                                <div class="panel panel-yellow">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <?php
                                              ...
                                              $listePays = $dom->getElementsByTagName('description');
                                              foreach($listePays as $pays)
